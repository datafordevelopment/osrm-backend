...
Intersection setIntersectionClasses(Intersection intersection, const PhantomNode &phantom);
} // ns detail
                                     ...
                                     const bool target_traversed_in_reverse)
{
    ...
    if (leg_data.size() > 0)
    {
        ...
        intersection = detail::setIntersectionClasses(std::move(intersection), source_node);
    ...
    intersection = detail::setIntersectionClasses(std::move(intersection), target_node);
