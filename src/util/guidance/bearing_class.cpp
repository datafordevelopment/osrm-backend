...
{
    BOOST_ASSERT(available_bearings.empty() || available_bearings.back() <= bearing);
...
{
    return static_cast<DiscreteBearing>((bearing + 0.5 * discrete_step_size) / discrete_step_size);
}
